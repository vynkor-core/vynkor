# Vynkor ROADMAP — Phases 8–14 (archived 2026-09-25)

> **Archived.** All items shipped except **K-06** (unscheduled), which moved
> to the live `ROADMAP.md` together with Phase 15. Kernel at archive time:
> `0.1.3`.
