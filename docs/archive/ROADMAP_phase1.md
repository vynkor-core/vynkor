...
## 11. Hardening Targets & Known Vulnerabilities

The hardening target list (T-01…T-07) and the tracked vulnerability table
(VULN-001…) now live in the dedicated top-level **[`ROADMAP.md`](../ROADMAP.md)**,
maintained as a living security tracker separate from this Phase-1.1 planning
document.
